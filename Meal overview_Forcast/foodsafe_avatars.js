    ...
    const AVATAR_CATALOG = [
        // ================= ROW 1: KITCHEN STAFF & HEROES =================
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-mia-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#FF758C" />
                        <stop offset="100%" stop-color="#FF7EB3" />
                    </linearGradient>
                    <linearGradient id="hair-mia-sub" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="#5D4037" />
                        <stop offset="100%" stop-color="#3E2723" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-mia-sub)" />
                ...
                <!-- Hair Back / Bun -->
                <circle cx="50" cy="30" r="28" fill="url(#hair-mia-sub)" />
                ...
                <!-- Hair Bangs / Front -->
                <path d="M30 42 C33 26 67 26 70 42 C64 33 58 35 50 35 C42 35 36 33 30 42 Z" fill="url(#hair-mia-sub)" />
                <path d="M30 42 C30 52 33 55 35 56 C34 48 35 44 35 42 Z" fill="url(#hair-mia-sub)" />
                <path d="M70 42 C70 52 67 55 65 56 C66 48 65 44 65 42 Z" fill="url(#hair-mia-sub)" />
                <!-- Eyes -->
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-pierre-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#4CA1AF" />
                        <stop offset="100%" stop-color="#C4E0E5" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-pierre-sub)" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-maya-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#654EA3" />
                        <stop offset="100%" stop-color="#EAAFC8" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-maya-sub)" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-leo-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#F9D423" />
                        <stop offset="100%" stop-color="#FF4E50" />
                    </linearGradient>
                    <linearGradient id="hair-leo-sub" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="#FFE082" />
                        <stop offset="100%" stop-color="#FFB300" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-leo-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="2" />
                ...
                <path d="M24 45 C20 30 35 15 50 15 C65 15 80 30 76 45 C78 52 74 60 70 60 C66 40 34 40 30 60 C26 60 22 52 24 45 Z" fill="url(#hair-leo-sub)" />
                <!-- Face -->
                <ellipse cx="50" cy="48" rx="20" ry="21" fill="#FFE0BD" />
                <!-- Ears -->
                ...
                <!-- Anime Hair Fringe -->
                <path d="M28 35 L38 42 L42 32 L50 44 L56 32 L64 42 L72 35 L68 24 C58 20 42 20 32 24 Z" fill="url(#hair-leo-sub)" />
                <!-- Rosy Cheeks -->
        ...
        // ================= ROW 2: PLAYFUL FOOD & VEGETABLE MASCOTS =================
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-chili-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#76B852" />
                        <stop offset="100%" stop-color="#8DC26F" />
                    </linearGradient>
                    <linearGradient id="chili-body-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-chili-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="2" />
                ...
                <!-- Chili Pepper Body -->
                <path d="M38 28 C30 45 36 68 45 78 C48 81 55 86 52 90 C45 85 30 70 28 50 C26 34 32 28 38 28 Z" fill="url(#chili-body-sub)" />
                <path d="M38 28 C45 28 64 35 66 52 C68 68 56 84 52 90 C50 82 44 75 40 65 C34 50 35 34 38 28 Z" fill="url(#chili-body-sub)" />
                ...
                <circle cx="63" cy="53" r="3.5" fill="#FF8A80" opacity="0.7" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-apple-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#56AB2F" />
                        <stop offset="100%" stop-color="#A8E063" />
                    </linearGradient>
                    <linearGradient id="apple-body-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-apple-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="2" />
                ...
                <path d="M50 33 C42 26 24 28 22 45 C20 66 36 84 48 85 C49 85 50 84 50 84 C50 84 51 85 52 85 C64 84 80 66 78 45 C76 28 58 26 50 33 Z" fill="url(#apple-body-sub)" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-pear-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#4FACFE" />
                        <stop offset="100%" stop-color="#00F2FE" />
                    </linearGradient>
                    <linearGradient id="pear-body-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-pear-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="2" />
                ...
                <!-- Pear Body Shape -->
                <path d="M50 26 C42 26 38 34 38 45 C38 52 26 58 26 70 C26 82 36 88 50 88 C64 88 74 82 74 70 C74 58 62 52 62 45 C62 34 58 26 50 26 Z" fill="url(#pear-body-sub)" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-pine-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#FCE38A" />
                        <stop offset="100%" stop-color="#F38181" />
                    </linearGradient>
                    <linearGradient id="pine-body-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#FFD54F" />
                        <stop offset="100%" stop-color="#FF8F00" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-pine-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="2" />
                ...
                <!-- Pineapple Body -->
                <ellipse cx="50" cy="58" rx="22" ry="26" fill="url(#pine-body-sub)" />
        ...
        // ================= ROW 3: MORE FUN FOOD & QUIRKY CHARACTERS =================
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-eggplant-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#00C9FF" />
                        <stop offset="100%" stop-color="#92FE9D" />
                    </linearGradient>
                    <linearGradient id="eggplant-body-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-eggplant-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="2" />
                ...
                <!-- Eggplant Body -->
                <path d="M50 25 C42 25 38 36 36 48 C34 62 26 68 26 76 C26 84 36 88 50 88 C64 88 74 84 74 76 C74 68 66 62 64 48 C62 36 58 25 50 25 Z" fill="url(#eggplant-body-sub)" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-shroom-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#FF9966" />
                        <stop offset="100%" stop-color="#FF5E62" />
                    </linearGradient>
                    <linearGradient id="cap-shroom-sub" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="#A1887F" />
                        <stop offset="100%" stop-color="#5D4037" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-shroom-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="2" />
                ...
                <!-- Mushroom Cap -->
                <path d="M50 18 C24 18 18 42 22 52 C24 55 76 55 78 52 C82 42 76 18 50 18 Z" fill="url(#cap-shroom-sub)" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-carrot-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#FF758C" />
                        <stop offset="100%" stop-color="#FF7EB3" />
                    </linearGradient>
                    <linearGradient id="carrot-body-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-carrot-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="2" />
                ...
                <!-- Carrot Body -->
                <path d="M32 32 C42 30 58 30 68 32 C70 42 62 65 52 90 C48 90 38 65 32 32 Z" fill="url(#carrot-body-sub)" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-grape-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#D299C2" />
                        <stop offset="100%" stop-color="#FEF9D7" />
                    </linearGradient>
                    <linearGradient id="grape-grad-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#AB47BC" />
                        <stop offset="100%" stop-color="#6A1B9A" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-grape-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="2" />
                ...
                <circle cx="34" cy="38" r="10" fill="url(#grape-grad-sub)" />
                <circle cx="66" cy="38" r="10" fill="url(#grape-grad-sub)" />
                <circle cx="50" cy="34" r="11" fill="url(#grape-grad-sub)" />
                <circle cx="28" cy="54" r="11" fill="url(#grape-grad-sub)" />
                <circle cx="72" cy="54" r="11" fill="url(#grape-grad-sub)" />
                <circle cx="38" cy="70" r="10" fill="url(#grape-grad-sub)" />
                <circle cx="62" cy="70" r="10" fill="url(#grape-grad-sub)" />
                <circle cx="50" cy="82" r="9" fill="url(#grape-grad-sub)" />
                <!-- Main Center Face Grape -->
                <circle cx="50" cy="54" r="15" fill="url(#grape-grad-sub)" />
        ...
        // ================= ROW 4: MORE TEAM HEROES & DIVERSE STAFF =================
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-alex-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#30CFD0" />
                        <stop offset="100%" stop-color="#330867" />
                    </linearGradient>
                    <linearGradient id="hair-alex-sub" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="#6D4C41" />
                        <stop offset="100%" stop-color="#3E2723" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-alex-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="2" />
                ...
                <path d="M43 60 H57 V72 H43 Z" fill="#FFDBAC" />
                <!-- Hair Back -->
                <circle cx="50" cy="36" r="26" fill="url(#hair-alex-sub)" />
                <!-- Face -->
                ...
                <path d="M26 38 C28 22 72 22 74 38 C68 30 58 32 50 32 C40 32 32 30 26 38 Z" fill="url(#hair-alex-sub)" />
                <path d="M26 38 C28 48 32 54 34 56 C32 46 30 42 26 38 Z" fill="url(#hair-alex-sub)" />
                <!-- Eyes -->
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-zara-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#FA709A" />
                        <stop offset="100%" stop-color="#FEE140" />
                    </linearGradient>
                    <linearGradient id="hair-zara-sub" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="#311B92" />
                        <stop offset="100%" stop-color="#1A237E" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-zara-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="2" />
                ...
                <path d="M24 45 C22 28 34 18 50 18 C66 18 78 28 76 45 C78 64 74 72 70 72 C68 55 32 55 30 72 C26 72 22 64 24 45 Z" fill="url(#hair-zara-sub)" />
                <!-- Face -->
                ...
                <path d="M25 35 C35 18 68 22 75 35 C70 28 55 26 44 32 C34 38 28 48 26 56 Z" fill="url(#hair-zara-sub)" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-kabir-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#11998E" />
                        <stop offset="100%" stop-color="#38EF7D" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-kabir-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="2" />
        ...
        },
        {
            ...
            svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="bg-sam-sub" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#5B86E5" />
                        <stop offset="100%" stop-color="#36D1DC" />
                    </linearGradient>
                </defs>
                <!-- Background Circle -->
                <circle cx="50" cy="50" r="48" fill="url(#bg-sam-sub)" />
                <circle cx="50" cy="50" r="46" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="2" />
